...
func (c *FakeSystemEnvs) UpdateStatus(ctx context.Context, systemEnv *v1alpha1.SystemEnv, opts v1.UpdateOptions) (*v1alpha1.SystemEnv, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(systemenvsResource, "status", systemEnv), &v1alpha1.SystemEnv{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.SystemEnv), err
